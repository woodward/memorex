defmodule Memorex.SchedulerTest do
  ...
  describe "learn_ahead_time" do
    test "uses the config :learn_ahead_time_interval value" do
      ...
      learn_ahead_time_twenty_minutes_from_now = Scheduler.learn_ahead_time(config, now)
  ...
  describe "is_card_due?/2" do
    ...
    test "is true for a card in the new queue, regardless of anything else", %{config: config} do
      ...
      assert Scheduler.is_card_due?(card, config, now) == true
    end
    ...
    test "is false for a :learn card if the card due date is greater than now plus the learn-ahead time", %{config: config} do
      ...
      assert Scheduler.is_card_due?(card, config, now) == false
    end
  ...
  describe "implemented tests from Anki" do
    ...
    test "test_learn" do
      # Corresponds to test_learn() in pylib/tests/test_schedv2.py in Anki
    end
  end
  ...
  describe "future tests from Anki" do
    @tag :skip
    test "test_clock" do
      # Corresponds to test_clock() in pylib/tests/test_schedv2.py in Anki
    end

    @tag :skip
    test "test_basics" do
      # Corresponds to test_basics() in pylib/tests/test_schedv2.py in Anki
    end

    @tag :skip
    test "test_learn_day" do
      # Corresponds to test_learn_day() in pylib/tests/test_schedv2.py in Anki
    end

    @tag :skip
    test "test_reviews" do
      # Corresponds to test_reviews() in pylib/tests/test_schedv2.py in Anki
    end

    @tag :skip
    test "test_review_limits" do
      # Corresponds to test_review_limits() in pylib/tests/test_schedv2.py in Anki
    end

    @tag :skip
    test "test_button_spacing" do
      # Corresponds to test_button_spacing() in pylib/tests/test_schedv2.py in Anki
    end

    @tag :skip
    test "test_overdue_lapse" do
      # Corresponds to test_overdue_lapse() in pylib/tests/test_schedv2.py in Anki
    end

    @tag :skip
    test "test_nextIvl" do
      # Corresponds to test_nextIvl() in pylib/tests/test_schedv2.py in Anki
    end

    @tag :skip
    test "test_bury" do
      # Corresponds to test_bury() in pylib/tests/test_schedv2.py in Anki
    end

    @tag :skip
    test "test_suspend" do
      # Corresponds to test_suspend() in pylib/tests/test_schedv2.py in Anki
    end

    @tag :skip
    test "test_filt_reviewing_early_normal" do
      # Corresponds to test_filt_reviewing_early_normal() in pylib/tests/test_schedv2.py in Anki
    end

    @tag :skip
    test "test_relearn" do
      # Corresponds to test_relearn() in pylib/tests/test_schedv2.py in Anki
    end

    @tag :skip
    test "test_learn_collapsed" do
      # Corresponds to test_learn_collapsed() in pylib/tests/test_schedv2.py in Anki
    end

    @tag :skip
    test "test_relearn_no_steps" do
      # Corresponds to test_relearn_no_steps() in pylib/tests/test_schedv2.py in Anki
    end

    @tag :skip
    test "test_newLimits" do
      # Corresponds to test_newLimits() in pylib/tests/test_schedv2.py in Anki
    end

    @tag :skip
    test "test_newBoxes" do
      # Corresponds to test_newBoxes() in pylib/tests/test_schedv2.py in Anki
    end

    @tag :skip
    test "test_filt_keep_lrn_state" do
      # Correponds to test_filt_keep_lrn_state() in pylib/tests/test_schedv2.py in Anki
    end

    @tag :skip
    test "test_preview" do
      # Correponds to test_preview() in pylib/tests/test_schedv2.py in Anki
    end

    @tag :skip
    test "test_ordcycle" do
      # Correponds to test_ordcycle() in pylib/tests/test_schedv2.py in Anki
    end

    @tag :skip
    test "test_counts_idx" do
      # Correponds to test_counts_idx() in pylib/tests/test_schedv2.py in Anki
    end

    @tag :skip
    test "test_counts_idx_new" do
      # Correponds to test_counts_idx_new() in pylib/tests/test_schedv2.py in Anki
    end

    @tag :skip
    test "test_repCounts" do
      # Correponds to test_repCounts() in pylib/tests/test_schedv2.py in Anki
    end

    @tag :skip
    test "test_timing" do
      # Correponds to test_timing() in pylib/tests/test_schedv2.py in Anki
    end

    @tag :skip
    test "test_collapse" do
      # Correponds to test_collapse() in pylib/tests/test_schedv2.py in Anki
    end

    @tag :skip
    test "test_deckDue" do
      # Correponds to test_deckDue() in pylib/tests/test_schedv2.py in Anki
    end

    @tag :skip
    test "test_deckTree" do
      # Correponds to test_deckTree() in pylib/tests/test_schedv2.py in Anki
    end

    @tag :skip
    test "test_deckFlow" do
      # Correponds to test_deckFlow() in pylib/tests/test_schedv2.py in Anki
    end

    @tag :skip
    test "test_reorder" do
      # Correponds to test_reorder() in pylib/tests/test_schedv2.py in Anki
    end

    @tag :skip
    test "test_forget" do
      # Correponds to test_forget() in pylib/tests/test_schedv2.py in Anki
    end

    @tag :skip
    test "test_resched" do
      # Correponds to test_resched() in pylib/tests/test_schedv2.py in Anki
    end

    @tag :skip
    test "test_norelearn" do
      # Correponds to test_norelearn() in pylib/tests/test_schedv2.py in Anki
    end

    @tag :skip
    test "test_failmult" do
      # Correponds to test_failmult() in pylib/tests/test_schedv2.py in Anki
    end

    @tag :skip
    test "test_negativeDueFilter" do
      # Correponds to test_negativeDueFilter() in pylib/tests/test_schedv2.py in Anki
    end

    @tag :skip
    test "test_initial_repeat" do
      # Correponds to test_initial_repeat() in pylib/tests/test_schedv2.py in Anki
    end
  end
end
